document.addEventListener('DOMContentLoaded', () => {
    ...
    function createLoveText() {
        ...
        const loveTextGeometry = new THREE.TextGeometry("I Love You Tiaa Mera Baccha", {
            font: loadedFont,
    ...
    function setupAudio() {
       audio = document.getElementById('backgroundMusic');
        ...
        // Add a safety check in case the element wasn't loaded
        if (!audio) {
            console.error("Audio element with ID 'backgroundMusic' not found. Check your HTML.");
            return;
        }
        ...
        audio.addEventListener('canplaythrough', () => {
            if (!source) {
                // Connect the retrieved HTML audio element to the audio context
        ...
        audio.addEventListener('error', (e) => {
            ...
            alert('Could not load audio file. Please make sure your HTML <audio> tag sources are correct.');
        });
    }
      ...
      function toggleMusic() {
        ...
        if (!isPlaying) {
            ...
            audio.play().then(() => {
                ...
                alert('Could not play audio. Please click anywhere on the page first, then try again, or check your console for errors.');
                isPlaying = false;
            });
        } else {
            // Pause playing
